...
const newImplementation = `export async function generate3InchBillHTML(
  ...
  // Assuming 1 point per 100 spent for earned points as example, or use a field if it exists
...
<head>
  ...
  <style>
    ...
    body {
      ...
      font-size: 13px;
      font-weight: 800; /* Bold font everywhere */
      line-height: 1.3;
      width: 100%;
      max-width: 80mm;
      margin: 0 auto;
    ...
    .bill-title { text-align: center; font-size: 14px; font-weight: 900; margin: 10px 0 6px; }
    ...
    .items-table { font-size: 13px; margin-bottom: 5px; font-weight: 800; }
    .items-table th { border-bottom: 1px dashed #000; border-top: 1px dashed #000; padding: 4px 0; text-align: left; }
    .items-table td { vertical-align: top; padding: 2px 0; }
    
    .totals-table { width: 100%; font-size: 13px; font-weight: 800; margin-bottom: 5px; }
    .totals-table td { padding: 2px 0; }
    
    .bank-details { font-size: 12px; margin-top: 8px; line-height: 1.4; font-weight: 800; }
    .terms { font-size: 12px; margin-top: 8px; line-height: 1.4; font-weight: 800; }
  </style>
</head>
<body>
  <div class="header">
  ...
  <div class="text-center" style="margin: 12px 0;">
    ...
    <div style="font-size: 11px; font-weight: 900; margin-top: 4px;">Scan this QR Code to pay</div>
  </div>

  <div class="dashed-line"></div>
  
  <div class="bank-details">
    <div style="font-weight: 900; text-decoration: underline;">Bank Details</div>
